...
namespace EFAdventureWorks.Storing
{
    public partial class AdventureWorks2017Context : DbContext
    {
        ...
        public virtual DbSet<VwGetpersons> VwGetpersons { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("server=localhost;database=AdventureWorks2017;user id=sa;password=Boogyman98!");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VwGetpersons>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_getpersons");
